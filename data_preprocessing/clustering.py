...
class KMeansClustering:
    ...
    def elbow_plot(self, data):
        ...
        try:
            for i in range(1,11):
                ...
                kmeans.fit(data)   # fitting the data to KMeans Algorithm
                wcss.append(kmeans.inertia_)
            plt.plot(range(1,11),wcss)  # creating the graph between WCSS and the number of cluster
    ...
    def create_clusters(self, data, number_of_clusters):
        ...
        try:
            ...
            self.file_object.log(self.file_object, 'Exception occurred in the create_clusters method of the KMeansClustering Class. Exception message: ' + str(e))
